...
# # python3 -m torch.distributed.launch --nproc_per_node=<n_gpus> --master_port=8888 train.py --data_path=<data_path>
    ...
    for idx in pbar:
        ...
        if get_rank() == 0:
            pbar.set_description(
                (
                    f"d: {d_loss_val:.4f}; real: {real_score_val:.4f}; fake: {fake_score_val:.4f}; "
                    f"g: {g_loss_val:.4f}; r1: {r1_val:.4f}; "
...
if __name__ == "__main__":
    ...
    dataset = RealDataset(data_path = args.data_path,
                          split     = "train", 
                          transform = transform)
